...
import com.example.viewpagerbroswer.Allsites.PlaceholderFragment;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		//执行查询方法
		query.findObjects(this, new FindListener<test>() {
		        @Override
		        ...
		        private void initListView(List<test> object) {
					// TODO Auto-generated method stub
		              ...
		              allsiteList.setAdapter(adapter);//为L
		              allsiteList.setOnItemClickListener(new OnItemClickListener() {
				        	@Override
...
startActivity(iintent);
       ...
       /* sharewebview  =(WebView)view4.findViewById(R.id.sharewebview);
        sharewebview.loadUrl("http://gisdaodao.github.io/itsites/add.html");
      ...
      //  webSettings.setDisplayZoomControls(false);        
       // webSettings.setAllowFileAccess(true); // 允许访问文件  
        ...
        webSettings.setLoadWithOverviewMode(true);  
        sharewebview.setScrollBarStyle(0);//滚动条风格，为0指滚动条不占用空间，直接覆盖在网页上 
*/        viewList.add(view1);
        viewList.add(view2);
        viewList.add(view3);
        viewList.add(view4);
